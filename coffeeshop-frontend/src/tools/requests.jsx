// Code adapted from https://github.com/strazdinsg/web-examples/blob/main/public_html/examples/react/15-react-jwt-auth/src/tools/requests.js
  ...
  return fetch(fullUrl, {
    ...
    .then((response) =>
      response
        .text()
        .then((text) =>
          text ? (returnPlainText ? text : JSON.parse(text)) : null
        )
    );
}
