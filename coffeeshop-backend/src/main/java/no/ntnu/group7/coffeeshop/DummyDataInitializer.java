  ...
  public void onApplicationEvent(ApplicationReadyEvent event) {
    ...
    if (userRepository.count() == 0) {
      ...
      Product brazilianCoffee = new Product("Brazilian coffee", new BigDecimal(80),
          "This delicious Brazilian coffee is sealed for freshness, giving you the ultimate coffee-drinking experience. With a full-bodied taste and subtle notes of chocolate, this coffee is sure to become your favorite. Enjoy the unique Brazilian flavor in every sip!",
          "brazillianCoffee", 15);

      Product greenTea = new Product("Green tea", new BigDecimal(50),
          "Our pack of green tea is the perfect refresher. Known for its antioxidants and relaxing qualities, our green tea is a healthy and delicious choice.",
          "greenTea", 10);

      Product peruCoffeeBeans = new Product("Peru coffee beans", new BigDecimal(120),
          "This bag of premium coffee beans from Peru is the perfect way to start your day. Grown in the highlands of Peru, the beans are carefully harvested and sealed for maximum freshness. This medium roast coffee is known for its full-bodied flavor and sweet, nutty aroma. Enjoy the smooth, creamy flavor that a cup of coffee from Peru can provide. Perfect for any coffee lover, these beans will help you create the perfect cup of coffee every morning.",
          "peruCoffeeBeans", 1);

      Product blackTea = new Product("Black tea", new BigDecimal(60),
          "Our pack of black tea provides a classic, robust flavor. Perfect for a morning wake-up or an afternoon pick-me-up, enjoy the robust, full-bodied taste of our black tea.",
          "blackTea", 20);

      Product earlGreyTea = new Product("Earl Grey tea", new BigDecimal(70),
          "Our pack of Earl Grey tea is a fragrant delight. The refreshing citrus notes and the calming properties of bergamot make our Earl Grey a tea lover's favorite.",
          "earlGreyTea", 5);

      Product chamomileTea = new Product("Chamomile tea", new BigDecimal(40),
          "Our pack of chamomile tea is the perfect companion for relaxation. Known for its calming properties, chamomile tea is a great choice for a stress-free evening.",
          "chamomileTea", 15);

      Product arabicaCoffee = new Product("Arabica coffee", new BigDecimal(100),
          "Our pack of ground Arabica coffee offers a smooth and slightly sweet flavor. Enjoy the rich, full-bodied taste of our 100% Arabica coffee.",
          "arabicaCoffee", 10);

      Product colombiaCoffeeBeans = new Product("Colombia coffee beans", new BigDecimal(110),
          "Our pack of Colombia coffee beans provide a full-bodied, rich flavor with a slight hint of nuttiness. Enjoy the robust flavors of our carefully sourced Colombia coffee beans.",
          "colombiaCoffeeBeans", 5);

      Product whiteTea = new Product("White tea", new BigDecimal(80),
          "Our pack of white tea offers a delicate and sweet flavor. Enjoy the subtle, slightly sweet taste of our carefully harvested white tea leaves.",
          "whiteTea", 15);

      Product oolongTea = new Product("Oolong tea", new BigDecimal(90),
          "Our pack of Oolong tea provides a unique flavor that's both robust and delicate. Enjoy the complex, layered flavors of our Oolong tea, perfect for tea connoisseurs.",
          "oolongTea", 10);

      // Other products
      Product chocolate = new Product("Chocolate", new BigDecimal(150),
          "Indulge in the ultimate decadence with our delicious 70% cocoa chocolate. Carefully crafted from the finest ingredients, this chocolate is sure to satisfy your sweet tooth. With a grid that makes it easy to break into smaller pieces, it's perfect for baking or for eating straight. Enjoy the smooth, refreshing flavor of this high-quality chocolate and indulge in a treat that is truly unforgettable.",
          "chocolate", 40);
      ...
      List<Product> teaAndCoffeeProducts = Arrays.asList(brazilianCoffee, peruCoffeeBeans, blackTea,
          earlGreyTea, chamomileTea, arabicaCoffee, colombiaCoffeeBeans, whiteTea,
          oolongTea);
